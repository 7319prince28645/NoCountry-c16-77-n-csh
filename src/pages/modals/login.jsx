...
const Modal = ({ isOpen, onClose, children }) => {
  ...
  return (
    <animated.div
      ...
      className="fixed z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none w-[45%] bg-white"
    >
      <div className="fixed inset-0 bg-black opacity-60"></div>
      <div className="relative h-full w-full">
        <div className="relative flex flex-col h-screen bg-white   outline-none focus:outline-none">
         
          <div className="relative h-full flex flex-col justify-center p-8 w-full">
